...
> **⚠️ Aclaración sobre el mailer:** 
Las variables relacionadas con el envío de correos (MAIL_HOST, MAIL_PORT, MAIL_USER, MAIL_PASS y MAIL_FROM) son necesarias para que el proyecto pueda enviar los emails de confirmación y cancelación de tickets. 
Se utiliza Gmail como proveedor SMTP, por lo que MAIL_USER debe ser una cuenta de Gmail y MAIL_PASS una contraseña de aplicación generada desde el link indicado (no la contraseña habitual de la cuenta).
